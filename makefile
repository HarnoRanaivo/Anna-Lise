...
unit_tests: unit_tests.o test_base.o test_icmp_util.o icmp_util.o | bin
	$(CC) $(CFLAGS) -o $(BPATH)/unit_tests $(OPATH)/unit_tests.o $(OPATH)/test_base.o $(OPATH)/test_icmp_util.o $(OPATH)/icmp_util.o $(LFLAGS) -lcunit
...
test_address.o: test_address.c address.h base.h
